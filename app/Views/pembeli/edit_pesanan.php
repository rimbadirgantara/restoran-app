            ...
            <div class="col mt-4">
                <div class="card mb-4">
                    <div class="card-header pb-0 p-3">
                        <h6 class="mb-1">Form Edit Pesanan</h6>
                    </div>
                        ...
                        <div class="row">
                            ...
                            <div class="table-responsive p-0">
                                <table class="table align-items-center mb-0">
                                    ...
                                    <form action="<?= base_url('/a/' . $_makanan['id'] . '/' . $makanan['slug'] .  '/sendeditpesanan'); ?>" method="post">
                                        <tbody>
                                            <tr>
                                                <td>
                                                ...
                                                <td>
                                                    <div class="d-flex px-2 py-1">
                                                        <div class="d-flex flex-column justify-content-center">
                                                            ...
                                                            <input type="number" name="jumlah_porsi" id='jumlah_porsi' class="form-control <?= ($validation->hasError('jumlah_porsi')) ? 'is-invalid' : '' ?>" placeholder="Jumlah Porsi" onchange="jumlah_harga();" value="<?= $_makanan['porsi']; ?>">
